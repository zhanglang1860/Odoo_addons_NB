...
class RoadBasementDatabase:
    def __init__(self):
        ...
        self.bridge_3, self.grade, self.capacity, self.slope_area, self.terrain_type = 0, 0, 0, 0, []
    ...
    def generate_dict(self, data1, data2, data3, data4):
        self.data_1 = data1
        self.data_2 = data2
        self.data_3 = data3
        self.data_4 = data4
...
Dict = round_dict(project04.generate_dict(data_cal, data_ca2, data_ca3, data_ca4))
print(Dict)
