...
class Cable(ElectricalCircuit):
    ...
    def __init__(self, *value_list):
        ...
        self.cable_model_YJLV22_26_35_3_95_g, self.cable_model_YJV22_26_35_1_300_g = 0, 0
        self.cable_model_cable_duct = 0
        self.cable_model_YJLV22_26_35_3_95_d, self.cable_model_YJV22_26_35_1_300_d = 0, 0
    ...
    def cable_model(self, cable_project, cable_model):
        ...
        if self.cable_project == "高压电缆":
            if self.cable_model == "YJLV22_26_35_3_95_g":
                self.cable_model_YJLV22_26_35_3_95_g = self.buried_cable_35_3
            elif self.cable_model == "YJV22_26_35_1_300_g":
                self.cable_model_YJV22_26_35_1_300_g = self.buried_cable_35_1
        if self.cable_project == "电缆沟":
            if self.cable_model == "电缆沟长度":
                self.cable_model_cable_duct = 3.2
        if self.cable_project == "电缆终端":
            if self.cable_model == "YJLV22_26_35_3_95_d":
                self.cable_model_YJLV22_26_35_3_95_d = self.tur_number * 2
            elif self.cable_model == "YJV22_26_35_1_300_d":
                self.cable_model_YJV22_26_35_1_300_d = self.line_loop_number * 2
...
#
# print(project02.cable_model_YJLV22_26_35_3_95_g, project02.cable_model_YJV22_26_35_1_300_g,
