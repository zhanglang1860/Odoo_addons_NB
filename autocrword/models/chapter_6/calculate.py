...
class TowerType(ElectricalCircuit):
    def __init__(self):
        super().__init__(25.3, 23.6, 1.55, 3, 31, 5, )
        self.tower_type = ''
        ...
        # self.sum_tower_weight = 0
        self.sum_tower_number_weight = 0
        #
        # self.tower_type_list = tower_type_list
        # self.tower_type_high_list = tower_type_high_list
        # self.tower_weight_list = tower_weight_list
    ...
    def sum_cal(self, tower_type_list, tower_type_high_list, tower_weight_list):
        for i in range(0, len(tower_weight_list)):
            ...
            print(self.tower_type, self.tower_type_high, self.used_numbers)
               # self.sum_tower_weight += self.tower_number_weight
            if self.tower_type=="铁塔电缆支架":
...
project02.sum_cal(tower_type_list, tower_type_high_list, tower_weight_list)

print(project02.sum_tower_number_weight)
